  ...
  <section class="container mx-auto px-4 py-16 space-y-16">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mt-10">
      ...
      <div class="flex justify-center">
        <img src="../../assets/images/guinchos/luna_01.jpg" alt="Luna 01" />
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
      <div>
        <img
          src="../../assets/images/guinchos/luna_02.jpg"
          alt="Luna 02"
        />
      </div>
      <div class="text-center md:text-left">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mt-10">
      ...
      <div class="flex justify-center">
        <img src="../../assets/images/guinchos/06.jpg" alt="MD 43607" />
      </div>
    </div>

    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
      <div>
        <img src="../../assets/images/guinchos/03.jpg" alt="HYVA 450 BR" />
      </div>
      <div class="text-center md:text-left">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mt-10">
      ...
      <div class="flex justify-center">
        <img src="../../assets/images/guinchos/05.jpg" alt="LUNA 57508" />
      </div>
    </div>

    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
      <div>
        <img src="../../assets/images/guinchos/04.jpg" alt="LUNA 57508" />
      </div>
      <div class="text-center md:text-left">
        <h2 class="text-2xl font-bold mb-4">GUINCHO LUNA 57508</h2>
        <p class="text-lg leading-relaxed">
